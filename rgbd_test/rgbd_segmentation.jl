...
function segment_rgbd_with_seperate_depth_weight(img_path,depth_path,out_path,rgb_prior_multiplier,xy_prior_multiplier,depth_multiplier,nu)
    img = load(img_path)
    depth = load(depth_path)
    #depth normalization
    depth = Float32.(depth)
...
segment_rgbd_with_seperate_depth_weight(img_path,depth_path,"rgbd_result.png",rgb_prior_multiplier,xy_prior_multiplier,depth_prior_multiplier,nu)
